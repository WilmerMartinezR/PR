...
nom_out2 <- paste(file.data, "MeadianHP.xlsx",sep = "")
...
Full_list_variables <- "D + Time + HI+y5_17 +
                     y18_34+y35_64+y65_74+Unemp+Male+IncomePC+BLSratio"

Full_list_variables_wD <- "Time + HI+y5_17 +
                     y18_34+y35_64+y65_74+Unemp+Male+IncomePC+BLSratio"

# counter effet variable name
CountFE_name = "MedianH0"
...
# Result
# outputUnitChang
chang_MHP <- model_ChangU1$ModelFit # interact D
...
plot(chang_MHP$SigPval[-c(1:6)], chang_MHP$Estimate[-c(1:6)], xlab="Significant",
     ylab="", main="Hurricane Effect")
abline(h=0,col="red")
plot(chang_MHP2$SigPval[-c(1:6)], chang_MHP2$Estimate[-c(1:6)], xlab="Significant",
     ylab="", main="y5_17 Effect")
abline(h=0,col="red")
plot(chang_MHP3$SigPval[-c(1:6)], chang_MHP3$Estimate[-c(1:6)], xlab="Significant",
     ylab="", main="Income Effect")
abline(h=0,col="red")
plot(chang_MHP4$SigPval[-c(1:6)], chang_MHP4$Estimate[-c(1:6)], xlab="Significant",
...
chang_MHP_all2 <- chang_MHP_all[-c(1:6),]  
...
chang_MHP_allA <- chang_MHP_all2
#summary(lm(Suicides4$MedianH[15:21] ~ Suicides4$y5_17[15:21]*Suicides4$D[15:21]))
#plot(Suicides4$MedianH[15:21] ~ Suicides4$y5_17[15:21])
#plot(Suicides4$MedianH[22:28] ~ Suicides4$y5_17[22:28])
#summary(lm(Suicides4$MedianH[22:28] ~ Suicides4$y5_17[22:28]))
#summary(lm(Suicides4$MedianH[22:28] ~ Suicides4$y5_17[22:28]*Suicides4$D[22:28]))
